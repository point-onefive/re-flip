      ...
      <main className="container mx-auto px-3 sm:px-4 py-6 sm:py-8">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-gray-400 text-base sm:text-lg mb-6 sm:mb-8 max-w-2xl mx-auto px-2">
            The simplest onchain game. Create a game, invite a friend or find an
            opponent, and flip a coin. Winner takes all (minus 1% fee).
          </p>

          {isConnected ? (
            <button
              onClick={() => setShowCreateModal(true)}
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-xl text-lg transition-colors"
            >
              Create New Game
            </button>
          ) : (
